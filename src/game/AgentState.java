...
public class AgentState {
	 ...
	 * @param cameraArmLength the camera arm length.
	 */
	public AgentState(Point2D position, double heading, boolean hasCamera, double cameraArmLength) {
	 ...
	 * @param as the state to duplicate.
	 */
	...
	public boolean equals(Object o) {
		...
		return (position.equals(other.position) &&
				...
				(!hasCamera || cameraArmLength == other.cameraArmLength));
	}
